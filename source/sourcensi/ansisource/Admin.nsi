...
!define ORIG "ADMINV2R"
!define DUPL "Admin"
!define NAME "${DUPL}"
!define FRIENDLYNAME "${ORIG}"
!define APP "${ORIG}"
!define VER "2.0.0.0"
!define WEBSITE "http://www.profitzsolution.com"
!define DEFAULTEXE "${ORIG}.exe"
!define DEFAULTAPPDIR "${ORIG}"
        ...
        ;=== Find the INI file, if there is one
                ...
                DisplaySplash:
                        ...
                        StrCmp $DISABLESPLASHSCREEN "true" SkipSplashScreen
                                ...
                                InitPluginsDir
                                File /oname=$PLUGINSDIR\splash.jpg "none.jpg"
